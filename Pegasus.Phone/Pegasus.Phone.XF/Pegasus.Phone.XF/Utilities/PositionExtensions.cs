...
{
    // borrowed from https://github.com/XLabs/Xamarin-Forms-Labs/blob/master/src/Platform/XLabs.Platform/Services/GeoLocation/PositionExtensions.cs
    public static class PositionExtensions
    {
        ...
        public static Distance DistanceFrom(this Position a, Position b)
        {
            /*
            ...
            return Distance.FromMeters(EquatorRadius * distance);
        }
